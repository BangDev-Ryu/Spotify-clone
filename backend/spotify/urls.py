...
from .views import user_list, artist_list, album_list, track_list, playlist_list, playlisttrack_list, like_list, follower_list, premium_list, userpremium_list, payment_list, track_detail
...
urlpatterns = [
    ...
    path('users/<int:pk>/', user_list, name='user_detail'),
